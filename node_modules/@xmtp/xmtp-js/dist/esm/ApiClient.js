...
const toNanoString = (d) => {
    return d && Long.fromNumber(d.valueOf()).multiply(1000000).toString();
};
...
export default class ApiClient {
    ...
    _query(req) {
        return retry(MessageApi.Query, [req, { pathPrefix: this.pathPrefix, mode: 'cors' }], this.maxRetries, RETRY_SLEEP_TIME);
    }
