...
class Message {
    ...
    static fromBytes(bytes) {
        return __awaiter(this, void 0, void 0, function* () {
            const msg = proto_1.xmtpEnvelope.Message.decode(bytes);
            const innerMessage = extractV1Message(msg);
            const header = proto_1.xmtpEnvelope.MessageHeader.decode(innerMessage.headerBytes);
    ...
    static encode(sender, recipient, message, timestamp) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const headerBytes = proto_1.xmtpEnvelope.MessageHeader.encode(header).finish();
    ...
    static decode(viewer, bytes) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            const message = proto_1.xmtpEnvelope.Message.decode(bytes);
            const v1Message = extractV1Message(message);
            const header = proto_1.xmtpEnvelope.MessageHeader.decode(v1Message.headerBytes);
            if (!header) {
