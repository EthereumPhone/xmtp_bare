...
class PublicKey {
    ...
    bytesToSign() {
        return proto_1.xmtpEnvelope.PublicKey.encode({
    ...
    toBytes() {
        return proto_1.xmtpEnvelope.PublicKey.encode(this).finish();
    }
    static fromBytes(bytes) {
        return new PublicKey(proto_1.xmtpEnvelope.PublicKey.decode(bytes));
    }
}
