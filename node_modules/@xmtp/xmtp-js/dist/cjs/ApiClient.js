...
exports.SortDirection = exports.MessageApi = void 0;
...
const toNanoString = (d) => {
    return d && long_1.default.fromNumber(d.valueOf()).multiply(1000000).toString();
};
...
class ApiClient {
    ...
    _query(req) {
        return (0, utils_1.retry)(exports.MessageApi.Query, [req, { pathPrefix: this.pathPrefix, mode: 'cors' }], this.maxRetries, RETRY_SLEEP_TIME);
    }
    ...
    _subscribe(req, cb) {
        ...
        const doSubscribe = () => {
            ...
            exports.MessageApi.Subscribe(req, cb, {
                pathPrefix: this.pathPrefix,
