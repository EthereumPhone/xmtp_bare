...
class CompositeCodec {
    ...
    encode(content, codecs) {
        ...
        const bytes = proto_1.composite.Composite.encode(composite).finish();
        return {
    ...
    decode(content, codecs) {
        return this.fromProto({ composite: proto_1.composite.Composite.decode(content.content), part: undefined }, codecs);
    }
