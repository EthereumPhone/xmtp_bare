...
const xmtp_envelope_pb_1 = require("../../message_contents/xmtp_envelope.pb");
...
exports.Token = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.identityKey !== undefined) {
            xmtp_envelope_pb_1.PublicKey.encode(message.identityKey, writer.uint32(10).fork()).ldelim();
        }
        if (message.authDataBytes.length !== 0) {
            writer.uint32(18).bytes(message.authDataBytes);
        }
        if (message.authDataSignature !== undefined) {
            xmtp_envelope_pb_1.Signature.encode(message.authDataSignature, writer.uint32(26).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.identityKey = xmtp_envelope_pb_1.PublicKey.decode(reader, reader.uint32());
                    break;
                case 2:
                    message.authDataBytes = reader.bytes();
                    break;
                case 3:
                    message.authDataSignature = xmtp_envelope_pb_1.Signature.decode(reader, reader.uint32());
                    break;
                default:
    ...
    fromJSON(object) {
        return {
            identityKey: isSet(object.identityKey)
                ? xmtp_envelope_pb_1.PublicKey.fromJSON(object.identityKey)
                : undefined,
            ...
            authDataSignature: isSet(object.authDataSignature)
                ? xmtp_envelope_pb_1.Signature.fromJSON(object.authDataSignature)
                : undefined,
        };
    },
    toJSON(message) {
        ...
        message.identityKey !== undefined &&
            (obj.identityKey = message.identityKey
                ? xmtp_envelope_pb_1.PublicKey.toJSON(message.identityKey)
                : undefined);
        ...
        message.authDataSignature !== undefined &&
            (obj.authDataSignature = message.authDataSignature
                ? xmtp_envelope_pb_1.Signature.toJSON(message.authDataSignature)
                : undefined);
        return obj;
    },
    fromPartial(object) {
        ...
        message.identityKey =
            object.identityKey !== undefined && object.identityKey !== null
                ? xmtp_envelope_pb_1.PublicKey.fromPartial(object.identityKey)
                : undefined;
        ...
        message.authDataSignature =
            object.authDataSignature !== undefined &&
                ...
                ? xmtp_envelope_pb_1.Signature.fromPartial(object.authDataSignature)
                : undefined;
        return message;
    },
};
